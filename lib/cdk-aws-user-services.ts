...
export class CdkGigyaHelperStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const lambdaExecutionRole = new Role(this, 'AUSLambdaExecutionRole', {
      roleName: 'AUSLambdaExecutionRole',
    ...
    // create a role for identity pool
    const gigyaIdentityPool = new IdentityPool(this, 'GigyaIdentityPool', {
        IdentityPoolName: 'GigyaIdentities',
        OpenIdConnectProvderARNs: 'arn:aws:iam::384538104517:oidc-provider/oauth.gravitaz.co.uk'
    })
